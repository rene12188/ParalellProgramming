...
public class PowerBalancerEngine
{
    ...
    public PowerBalancerEngine(IList<ImportCommunity> importCommunities, PowerSystemConfig powerSystemConfig, Clock clock)
    {
        ...
        {
            _communities.Add(new Community(importCommunity, powerSystemConfig.GetProducer(importCommunity.Name),powerSystemConfig.GetConsumer(importCommunity.Name), _graphDistanceResolver, clock));
        }
