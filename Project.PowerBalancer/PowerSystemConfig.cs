...
{
    private readonly Dictionary<string, List<BaseProducer>> _producers = new Dictionary<string, List<BaseProducer>>();
    private readonly Dictionary<string, List<BaseConsumer>> _consumers = new Dictionary<string, List<BaseConsumer>>();
    ...
    public PowerSystemConfig()
    {
       ...
       _producers.Add("Graz-Umgebung", new List<BaseProducer>(){new ConstantProducer(18.5)});
       _producers.Add("Hartberg-Fürstenfel", new List<BaseProducer>(){new ConstantProducer(1.2)});
       _producers.Add("Leibnitz", new List<BaseProducer>(){new ConstantProducer(4.4)});
       ...
       _producers.Add("Murtal", new List<BaseProducer>(){new ConstantProducer(0.5)});
       ...
       _producers.Add("Weiz", new List<BaseProducer>(){new ConstantProducer(6.0)});
